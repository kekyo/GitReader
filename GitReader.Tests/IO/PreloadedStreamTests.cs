...
public sealed class PreloadedStreamTests
{
    ...
    public void PreloadedStream1()
    {
        ...
        var s = new PreloadedStream(new(null, expected, expected.Length), 0, expected.Length);
    ...
    public void PreloadedStream4()
    {
        ...
        var s = new PreloadedStream(new(null, expected, expected.Length), 1, expected.Length);
